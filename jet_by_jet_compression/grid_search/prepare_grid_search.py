...
for nodes in nodes_list:
    ...
    #     for wd in wds:
            ...
            rl(fname=curr_job_name, findln='#SBATCH -o ', newline='#SBATCH -o %sAE_3D_%s.out' % (super_folder, curr_param_string))
            rl(fname=curr_job_name, findln='#SBATCH -e ', newline='#SBATCH -e %sAE_3D_%s.err' % (super_folder, curr_param_string))
